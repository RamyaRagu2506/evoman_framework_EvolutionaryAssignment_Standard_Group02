...
# Example usage:
diversity_df, best_fitness_df, mean_fitness_df, std_fitness_df = process_results_extended(base_dir='fs_enemy8', enemy=8, iterations=10, generations=50)
print(diversity_df)
...
# Example usage:
plot_fitness_results(best_fitness_df, mean_fitness_df, enemy=8, algorithm='With FS')
plot_diversity_results(diversity_df, enemy=8, algorithm='With FS')