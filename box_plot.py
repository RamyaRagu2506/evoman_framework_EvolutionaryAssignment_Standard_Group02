...
def create_gain_plot(es_file, fs_file):
    ...
    plt.title('Gain Plot for Enemy 8')
    plt.xlabel('Algorithms')
    plt.ylabel('Gain')
    plt.savefig('test/gain_plot_enemy8')

    # Show the plot
    plt.show()

# Example usage:
es_file_path = 'test/es_enemy_8.xlsx'  # Replace with actual path to the ES file
fs_file_path = 'test/fs_enemy_8.xlsx'  # Replace with actual path to the FS file
